...
public class IHelloService_wish_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.nt.proxy.IHelloService_wish_RequestStruct instance = new com.nt.proxy.IHelloService_wish_RequestStruct();
        com.nt.proxy.IHelloService_wish_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.nt.proxy.IHelloService_wish_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.nt.proxy.IHelloService_wish_RequestStruct instance = (com.nt.proxy.IHelloService_wish_RequestStruct)obj;
