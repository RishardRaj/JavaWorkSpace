...
public class PhantomThreadDemonManager {
	...
	public static void startDaemon() {
		if (phantomThread==null &&  daemonPhantom != null) {
			...
			if (!phantomThread.isAlive()) {
				phantomThread.start();
				System.out.println("Daemon Service Thread State " + phantomThread.getState().name());
				//logger.error("Daemon Service Thread State " + phantomThread.getState().name());
			} 
		}
		else {
	...
	public static void stopDaemon() {
		...
		if (phantomThread != null) {
			...
			System.out.println("Daemon Thread stopped already");
